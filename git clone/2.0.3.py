...
def scrape_nomer_tidak_keluar():
    ...
    url = 'https://www.siuuaksara4d.net/wap'
...
def main():
    ...
    while True:
        try:
            am1_input = input("MASUKAN AM1 (pisahkan dengan koma jika lebih dari satu, kosongkan jika tidak ada): ")
            if am1_input:
    ...
    while True:
        try:
            am2_input = input("MASUKAN AM2 (pisahkan dengan koma jika lebih dari satu, kosongkan jika tidak ada): ")
            if am2_input:
